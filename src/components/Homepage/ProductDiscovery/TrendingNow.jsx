                    ...
                    >
                        ...
                        <div className="p-4 flex flex-col flex-1">
                            ...
                            <Link href={`tile/${item.id}`} className="mt-auto">
                                <button className="w-full mt-3 bg-linear-to-r from-orange-500 to-red-500 text-white py-2 rounded-lg hover:opacity-90 transition">
                                    Explore Trend
                                </button>
                            </Link>
                        </div>
